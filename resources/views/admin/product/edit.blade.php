            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control d-none" id="file_name_add" name="thumbnail" placeholder="Tên file" value="{{$product->thumbnail}}">
                    </div>
                    ...
                    <div id="classify">
                        @foreach($product->classify as $classify)
                            <div class="d-flex justify-content-between wp-classify">
                                ...
                                <div class="item-add">
                                    <input type="text" name="images[]" placeholder="Hình ảnh sản phẩm" class="form-control" value="{{$classify->thumbnail}}" onclick="selectImg(this)">
                                </div>
